/**
 * @license
Modified by Brainsharer UCSD/Princeton
...
import { AnnotationLayerView, getLandmarkList, PlaceComTool, COMSession } from './annotations';
    ...
    getNewComRow() : HTMLTableRowElement {
      ...
      button.addEventListener('click', () => {
        ...
        this.annotationLayerView.layer.tool.value = new PlaceComTool(this.annotationLayerView.layer, {}, 
          undefined, this.annotationLayerView.comSession, this.annotationLayerView.comButton);
